...
Reference: https://github.com/random-robbie/keywords/blob/master/keywords.txt

## Testing secrets that were found
Check this repository: https://github.com/streaak/keyhacks
...
- To search for E-mails in all commits made: `git grep -o -E '[a-zA-Z0-9\.\_\-]+\@[a-zA-Z0-9._-]+' $(git rev-list --all) | grep -o -E '[a-zA-Z0-9\.\_\-]+\@[a-zA-Z0-9._-]+' | sort --unique`
